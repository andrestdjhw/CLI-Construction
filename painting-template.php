  ...
  <div class="relative max-w-7xl mx-auto px-4 py-20 lg:py-28 grid gap-12 lg:grid-cols-12">
    <div class="lg:col-span-7 cli-reveal-left">
      ...
      <p class="mt-5 text-ink/70 text-lg leading-relaxed max-w-2xl">
        CLI Constructions delivers durable finishes that boost aesthetics and property value across New Mexico. From full exteriors to unit interiors, our crews work on schedule and leave the property clean.
      </p>
