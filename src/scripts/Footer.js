...
const BG_VIDEO = HOME + "wp-content/uploads/2026/08/Steel-Gemetry-Background.mp4"
...
function Footer() {
  ...
  return (
    <footer className="bg-ink text-silver">
      ...
      {/* ============ DARK — statement + banda de datos, con video loop de fondo ============ */}
      <div className="relative overflow-hidden">
        <video
          className="cli-bg-video"
          src={BG_VIDEO}
          autoPlay
          muted
          loop
          ...
          aria-hidden="true"
        />
        <div className="cli-bg-video__veil cli-bg-video__veil--dark" aria-hidden="true" />
        ...
        <div className="relative border-t border-silver/25">
        ...
        <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-x-5 gap-y-2">
            {SOCIALS.map(s => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="cli-spec font-bold text-ink/60 hover:text-brand-2 transition-colors"
              >
                {s.label}
              </a>
            ))}
          ...
          <p className="cli-spec text-ink/55">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-bold hover:text-brand-2 transition-colors"
            >
