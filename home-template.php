...
$gallery = array(
  array('img' => '/wp-content/uploads/2026/08/CLIRenovations.webp',    'label' => 'Renovations'),
  array('img' => '/wp-content/uploads/2026/08/PaintingCLI-scaled.webp', 'label' => 'Painting'),
  array('img' => '/wp-content/uploads/2026/08/CLIStucco.webp',          'label' => 'Stucco'),
  array('img' => '/wp-content/uploads/2026/08/CLIRemodels.jpg',         'label' => 'Remodels'),
  array('img' => '/wp-content/uploads/2026/08/RoofingCLI.jpg',          'label' => 'Roofing'),
  array('img' => '/wp-content/uploads/2026/08/CLIFull.jpg',             'label' => 'Commercial Project'),
  array('img' => '/wp-content/uploads/2026/08/CLIFotos1-scaled.webp',   'label' => 'Multi-Housing Community'),
  array('img' => '/wp-content/uploads/2026/08/CLIFotos62-scaled.webp',  'label' => 'Property Upgrade'),
  array('img' => '/wp-content/uploads/2026/08/CLIFotos54-scaled.webp',  'label' => 'Completed Project'),
);
...
<section class="relative bg-ink overflow-hidden flex flex-col min-h-[calc(100svh-7.5rem)]">
  ...
  <div class="relative w-full max-w-7xl mx-auto px-4 py-16 lg:py-20 flex-grow flex items-center">
    ...
    <div class="lg:col-span-7 max-w-3xl cli-reveal-left is-visible">
      <h1 class="font-display font-extrabold leading-[1.02] tracking-tight text-[clamp(2.25rem,5.5vw,4rem)] cli-shine-text">
    ...
    <div class="lg:col-span-5 cli-reveal-right is-visible">
      <div
        class="cli-form-panel cli-levitate shadow-[0_18px_44px_-18px_rgb(0_0_0_/_0.35)]"
          ...
          >
            <div class="cli-card-media relative">
              <img
                ...
                loading="lazy"
              >
              <span class="cli-svc-num cli-shine-text" aria-hidden="true">
                <?php echo esc_html($s['num']); ?>
              </span>
            </div>
            <div class="flex flex-col flex-grow p-6 bg-paper-2">
...
<section id="reviews" class="relative cli-cubes overflow-hidden">
  ...
  <div class="relative max-w-7xl mx-auto px-4 py-20 lg:py-28">
    <div class="flex flex-wrap items-end justify-between gap-6">
      ...
      <a
        href="<?php echo esc_url('https://www.google.com/maps/search/?api=1&query=CLI+Construction+Albuquerque+NM'); ?>"
        target="_blank"
    ...
    <div class="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
      <?php foreach ($locations as $loc) : ?>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          class="group block bg-paper border border-ink/15 hover:bg-paper-2 hover:-translate-y-1 hover:shadow-[0_24px_44px_-20px_rgba(0,0,0,0.35)] transition-all duration-300 cli-reveal-stagger"
        >
          <div class="relative aspect-[4/3] overflow-hidden">
            <iframe
              src="https://www.google.com/maps?q=<?php echo urlencode($loc['city']); ?>&output=embed"
              class="w-full h-full grayscale-20 contrast-[1.05] pointer-events-none"
              style="border:0;"
              loading="lazy"
...
<section class="bg-ink py-16 lg:py-20 overflow-hidden">
  ...
  <div class="cli-marquee cli-marquee--cards cli-marquee--fade mt-10" aria-label="Recent work">
    <div class="cli-marquee__track flex items-stretch gap-6 w-max pt-3 pb-10 pr-6">
      <?php for ($copy = 0; $copy < 2; $copy++) : ?>
        <?php foreach ($gallery as $g) : ?>
          <a
            href="<?php echo esc_url(home_url('/gallery/')); ?>"
            class="cli-proj-card shrink-0"
            <?php echo $copy ? 'aria-hidden="true" tabindex="-1"' : ''; ?>
          >
            <div class="cli-proj-thumb">
              <img
                ...
                loading="lazy"
              >
              <div class="cli-proj-thumb__scrim" aria-hidden="true"></div>
              <span class="cli-proj-tag"><?php echo esc_html($g['label']); ?></span>
            </div>
            <div class="cli-proj-caption">
              <span class="cli-proj-dot" aria-hidden="true"></span>
...
<section class="cli-cubes">
  <?php cli_dark_bg_video(); ?>
  <div class="relative max-w-7xl mx-auto px-4 py-20 lg:py-28">
    <div class="max-w-2xl mx-auto cli-reveal-up">
      <h2 class="font-display font-extrabold text-paper tracking-tight text-[clamp(1.75rem,3.5vw,2.75rem)] leading-tight">
      ...
      <!-- Contact Form (React) -->
      <div class="mt-8 cli-form-panel" data-cli-contact-form></div>
    </div>

    <!-- Mapa — compacto, después del formulario -->
    <div class="max-w-2xl mx-auto mt-14 h-96 lg:h-112 border border-paper/15 cli-reveal-up">
      <iframe
