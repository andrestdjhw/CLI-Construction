...
<section id="estimate" class="cli-pattern">
  <div class="max-w-7xl mx-auto px-4 py-16 lg:py-24 grid gap-12 lg:grid-cols-12">
    ...
    <div class="lg:col-span-5">
      <h2 class="font-display font-extrabold text-ink tracking-tight text-[clamp(1.6rem,3vw,2.25rem)] leading-tight">
        Get in Touch
      </h2>
      ...
      <div class="mt-8 space-y-5">
        <div>
          ...
          <a href="tel:+15055181965" class="mt-1 inline-block text-ink text-lg hover:text-brand-2 transition-colors">
            (505) 518-1965
          </a>
        </div>
        <div>
          <p class="cli-spec text-silver">Email</p>
          <a href="mailto:office@cliconstructions.com" class="mt-1 inline-block text-ink text-lg hover:text-brand-2 transition-colors">
        ...
        <div>
          ...
          <a
            ...
            class="mt-1 inline-block text-ink text-lg hover:text-brand-2 transition-colors"
          >
            Albuquerque, NM
          </a>
        </div>
        <div>
          ...
          <p class="mt-1 text-ink text-lg leading-relaxed">
        ...
        <div>
          ...
          <div class="mt-2 flex flex-wrap gap-x-5 gap-y-2">
            <a href="https://www.facebook.com/cliconstruction" target="_blank" rel="noopener noreferrer" class="cli-spec text-ink/60 hover:text-brand-2 transition-colors">Facebook</a>
            <a href="https://www.instagram.com/cliconstruction" target="_blank" rel="noopener noreferrer" class="cli-spec text-ink/60 hover:text-brand-2 transition-colors">Instagram</a>
            <a href="https://www.yelp.com/biz/c-l-i-construction-albuquerque-2" target="_blank" rel="noopener noreferrer" class="cli-spec text-ink/60 hover:text-brand-2 transition-colors">Yelp</a>
          </div>
        </div>
      </div>
    </div>
